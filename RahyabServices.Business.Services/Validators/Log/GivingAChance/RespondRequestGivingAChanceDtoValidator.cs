...
namespace RahyabServices.Business.Services.Validators.Log{
    public class RespondRequestGivingAChanceDtoValidator : AbstractValidator<RespondRequestGivingAChanceDto>{
        public RespondRequestGivingAChanceDtoValidator(IStateRepository stateRepository)
        {
