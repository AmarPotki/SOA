...
{
    public class BranchMarketingRepositoryBase<TEntity> where TEntity : class, IBranchMarketingEntity
    {
        private readonly IDataContextFactory _dataContextFactory;
        public BranchMarketingRepositoryBase(IDataContextFactory databaseFactory)
        {
