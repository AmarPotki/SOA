...
{
    public class BankPersonRepositoryBase<TEntity> where TEntity : class , IBankPersonEntity
    {
        private readonly IDataContextFactory _dataContextFactory;
        public BankPersonRepositoryBase(IDataContextFactory databaseFactory)
        {
